...
export const CommentIcon = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    ...
    >
        ...
        <defs><linearGradient id="BubbleEllipsisRightFill_paint0_linear" x1="8.50426" y1="15.6957" x2="9.29499" y2="18.1805" gradientUnits="userSpaceOnUse"><stop></stop><stop offset="1" stopOpacity="0.01"></stop></linearGradient></defs>
    </svg>
)
...
export const ShareSolidIcon = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    <svg
        ...
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M10.9376 3.17495C10.9376 2.58272 11.6469 2.27873 12.0758 2.68715L18.6021 8.90241C19.1764 9.44937 19.1564 10.3717 18.5588 10.8931L12.0541 16.5689C11.6184 16.9491 10.9376 16.6397 10.9376 16.0614V13.4894C10.9376 13.4894 3.95344 12.2312 1.7131 16.3434C1.50423 16.7268 0.690072 16.8609 0.855563 14.948C1.54761 11.4273 2.96196 5.93084 10.9376 5.93084V3.17495Z" fill="currentColor"
        ></path>
        ...
        <defs>
            ...
            >
                <stop></stop><stop offset="0.995496" stopOpacity="0.01"></stop><stop offset="1" stopOpacity="0.01"></stop>
            </radialGradient>
        </defs>
    </svg>
)
...
export const EmailIcon = ({ className, width = '2.6rem', height = '2.6rem' }) => (
    ...
    >
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M24 48C37.2548 48 48 37.2548 48 24C48 10.7452 37.2548 0 24 0C10.7452 0 0 10.7452 0 24C0 37.2548 10.7452 48 24 48Z" fill="#0DBEF3"
        ></path>
        <path
            fillRule="evenodd"
            clipRule="evenodd"
...
export const EllipsisHorizontalIcon = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
